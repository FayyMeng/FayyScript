local _0xRoot = loadstring(game:HttpGet('https://raw.githubusercontent.com/shlexware/Rayfield/main/source'))()
...
local function _0xJump(wn, cf)
    if _0xH then
        ...
        _0xRoot:Notify({Title = "Teleport Success", Content = "Arrived at " .. wn, Duration = 2})
    end
end
...
-- [ UI INITIALIZATION ]
local W = _0xRoot:CreateWindow({Name = "FayyScript v2", LoadingTitle = "FayyScript Systems", ConfigurationSaving = {Enabled = false}})
...
T3:CreateLabel("Developer is working on it. Be patient!")
...
T4:CreateButton({Name = "🚀 Instant Dupe (5000x)", Callback = function()
    ...
    if idx and _0xRR then 
        ...
        _0xRoot:Notify({Title = "Success", Content = "Sent 5000 Requests", Duration = 2})
    end
end})
